        ...
        <div class="statbox widget box box-shadow">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$withdrawal->amount}} <small>{{$withdrawal->token->token_code}}</small></td>
                                <td><span class="badge badge-{{$withdrawal->status_class}} shadow-none badge-pill">{{$withdrawal->status_title}}</span></td>
                                <td><span class="flaticon-clock-2"></span> {{$withdrawal->created_at}}</td>
            ...
            <div class="widget-content text-center pt-4 pb-4 widget-content-area">
                <lottie-player class="mt-5 center-ani"  loop  autoplay src="https://assets2.lottiefiles.com/packages/lf20_rc6CDU.json"   background="transparent" speed="1"  style="width: 270px;" ></lottie-player>
                 ...
                 <a href="{{route('withdrawal.new',['token'=>'USDT'])}}" class="mb-2 btn btn-button-4 btn-rounded  mb-4 mr-2">Send new request</a>
            </div>
            @endif
        </div>
    </div>
