...
class WithdrawalRequestRecived extends Notification
{
    use Queueable;
    ...
    {   
        ...
        return (new MailMessage)
                    ->subject('We have received your withdrawal request '.$this->withdraw->amount.' '.$this->withdraw->token->token_name)
                    ->line('We have received your withdrawal request')
