...
<div class="row">
    ...
    <div class="col-xl-8">
        ...
        <form method="POST" action="{{ route('withdrawalFiat.confirm') }}">
            @csrf
            <div class="card overflow-hidden">
                ...
                <div class="card-body">
                    <p>Fill in the form below to submit a withdrawalFiat request, Minimum withdrawalFiat amount: ${{$min}}</p>
                    <hr>
...
@include('dex-withdrawalFiat::modals.add-new-wallet', ['token' => $token])
