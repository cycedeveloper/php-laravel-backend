...
use Sayedsoft\Dex\WalletDeposit\Models\ExtraBalance as ModelsExtraBalance;

class ExtraBalance extends Resource
{   
     ...
     * @var string
     */
    public static $model = ModelsExtraBalance::class;
