...
use Sayedsoft\Dex\WalletDeposit\Models\PaymentWalletsDeposit as ModelsPaymentWalletsDeposit;
use App\Helpers\AdvancedNumber;

class PaymentWalletsDeposit extends Resource
{   
     ...
     * @var string
     */
    public static $model = ModelsPaymentWalletsDeposit::class;
